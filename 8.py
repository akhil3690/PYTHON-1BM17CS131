...
def insertor():
    cur.execute("INSERT INTO STUDENT(SID,NAME,AGE,MARKS) VALUES(1650, 'Gaurav', 20, 71)")
    cur.execute("INSERT INTO STUDENT(SID,NAME,AGE,MARKS) VALUES(1651, 'Divyanshu', 21, 80)")
    cur.execute("INSERT INTO STUDENT(SID,NAME,AGE,MARKS) VALUES(1652, 'Saurav', 21, 78)")
    cur.execute("INSERT INTO STUDENT(SID,NAME,AGE,MARKS) VALUES(1653, 'Dev', 20, 70)")
    conn.commit()
...
def updator():
    cur.execute('UPDATE STUDENT SET name = "Sooraj" where SID = 1653')
    conn.commit()
